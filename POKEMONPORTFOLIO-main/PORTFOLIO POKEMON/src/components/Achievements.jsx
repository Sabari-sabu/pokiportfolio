    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://api.emailjs.com/api/v1.0/email/send', {
                ...
                body: JSON.stringify({
                    service_id: 'service_4uxcb5j',
                    template_id: 'template_elafu73',
                    user_id: 'ru-XtFn4dVKZSKaYA',
                    template_params: {
                        to_email: 'sabarij6383@gmail.com',
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <div>
                                ...
                                <div className="space-y-6">
                                    <a
                                        href="https://github.com/sabari-nathan"
                                        target="_blank"
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm font-pixel text-gray-300 group-hover:text-white">sabari-nathan</div>
                                        </div>
                                    </a>

                                    <a
                                        href="https://www.linkedin.com/in/sabari-nathan-251720321"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center gap-4 group cursor-pointer hover:scale-105 transition-transform"
                                    >
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm font-pixel text-gray-300 group-hover:text-white">sabari-nathan-251720321</div>
                                        </div>
                                    </a>

                                    <a
                                        href="mailto:sabarij6383@gmail.com"
                                        className="flex items-center gap-4 group cursor-pointer hover:scale-105 transition-transform"
                                    >
                                        <div className={`w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center group-hover:${bgColor} transition-colors`}>
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm font-pixel text-gray-300 group-hover:text-white">sabarij6383@gmail.com</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
